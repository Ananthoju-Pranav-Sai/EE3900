...
\begin{align}
    x(t\pm t_0)&\Longleftrightarrow X(f)e^{\pm j2\pi f t_0}\\
    x(\alpha t)&\Longleftrightarrow \frac{1}{|\alpha|}X\brak{\frac{f}{\alpha}}
\end{align}
We get
\begin{align}
    F(f) &= sinc\brak{f}e^{\brak{-j\pi f }} \label{b}\\ 
    G(f) &= 2sinc\brak{f}e^{-2j\pi f} \label{c}
\end{align}
Using $\eqref{a}$,$\eqref{b}$ and $\eqref{c}$
\begin{align}
    \implies Y(f) &= 2sinc\brak{2f}sinc\brak{f}e^{\brak{- 3j\pi f}}
\end{align}\\
\begin{figure}[!ht]
    \centering
