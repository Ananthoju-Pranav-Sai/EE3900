...
\begin{align}
    ...
    \implies \vec{r} &= \myvec{5-2\lambda\\1+3\lambda\\6-5\lambda}
\end{align}
Equation of ZX-plane is given by
\begin{align}
    y=0
\end{align}
So the y-coordinate of the point where the line crosses the ZX-plane is zero
\begin{align}
    1+3\lambda=0\\
    \lambda = \frac{-1}{3}
\end{align}
